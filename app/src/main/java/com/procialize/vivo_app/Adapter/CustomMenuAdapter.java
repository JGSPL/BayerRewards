...
public class CustomMenuAdapter extends RecyclerView.Adapter<CustomMenuAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if (menuSettingList.getFieldName().equalsIgnoreCase("side_menu_my_travel")) {
            ...
            holder.profileIv.setImageResource(R.drawable.notification);
            ...
            holder.profileIv.setImageResource(R.drawable.scan_qr);
            ...
            holder.nameTv.setText("Calendar");
            holder.profileIv.setImageResource(R.drawable.calender);
