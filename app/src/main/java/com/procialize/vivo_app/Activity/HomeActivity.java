...
import com.procialize.vivo_app.Adapter.CustomMenuAdapter;
import com.procialize.vivo_app.ApiConstant.ApiConstant;
import com.procialize.vivo_app.CustomTools.CustomViewPager;
import com.procialize.vivo_app.Fragments.AgendaFolderFragment;
import com.procialize.vivo_app.Fragments.AgendaFragment;
import com.procialize.vivo_app.Fragments.AttendeeFragment;

import com.procialize.vivo_app.Fragments.GeneralInfo;
import com.procialize.vivo_app.Fragments.SpeakerFragment;
import com.procialize.vivo_app.Fragments.WallFragment_POST;
import com.procialize.vivo_app.GetterSetter.EventMenuSettingList;
import com.procialize.vivo_app.GetterSetter.EventSettingList;
import com.procialize.vivo_app.InnerDrawerActivity.AgendaActivity;
import com.procialize.vivo_app.InnerDrawerActivity.AgendaVacationActivity;
import com.procialize.vivo_app.InnerDrawerActivity.AttendeeActivity;
import com.procialize.vivo_app.InnerDrawerActivity.CalendarActivity;
import com.procialize.vivo_app.InnerDrawerActivity.DocumentsActivity;
import com.procialize.vivo_app.InnerDrawerActivity.EngagementActivity;
import com.procialize.vivo_app.InnerDrawerActivity.EventInfoActivity;

import com.procialize.vivo_app.InnerDrawerActivity.FeedBackActivity;
...
import com.procialize.vivo_app.InnerDrawerActivity.QAAttendeeActivity;
import com.procialize.vivo_app.InnerDrawerActivity.QADirectActivity;
import com.procialize.vivo_app.InnerDrawerActivity.QASpeakerActivity;
import com.procialize.vivo_app.InnerDrawerActivity.QRGeneratorActivity;
import com.procialize.vivo_app.InnerDrawerActivity.QRScanActivity;
import com.procialize.vivo_app.InnerDrawerActivity.SpeakerActivity;
import com.procialize.vivo_app.InnerDrawerActivity.VideoActivity;
...
public class HomeActivity extends AppCompatActivity implements CustomMenuAdapter.CustomMenuAdapterListner {
    ...
    String news_feed = "0", attendee = "0", speaker = "0", agenda = "0", edit_profile = "0", general_ifo = "0", side_menu_leaderboard = "0",
            side_menu_calendar = "0";
    ...
    private void setupTabIcons() {
        ...
        if (tabLayout.getTabAt(1) != null) {
            if (tabLayout.getTabAt(1).getText().equals("News Feed")) {
                ...
                tabLayout.getTabAt(1).setIcon(R.drawable.selector_feed);

            } else if (tabLayout.getTabAt(1).getText().equals("Agenda")) {
                // tabLayout.getTabAt(1).setIcon(tabIcons[1]);
                tabLayout.getTabAt(1).setIcon(R.drawable.selector_agenda);

            } else if (tabLayout.getTabAt(1).getText().equals("Attendees")) {
                //tabLayout.getTabAt(1).setIcon(tabIcons[2]);
                tabLayout.getTabAt(1).setIcon(R.drawable.selector_attendees);

            } else if (tabLayout.getTabAt(1).getText().equals("Speakers")) {
                // tabLayout.getTabAt(1).setIcon(tabIcons[3]);
                tabLayout.getTabAt(1).setIcon(R.drawable.selector_speaker);

            } else if (tabLayout.getTabAt(1).getText().equals("General Info")) {
                tabLayout.getTabAt(1).setIcon(R.drawable.selector_info);
            }
        }
...
//                }
        ...
        }else if (menuSettingList.getFieldName().equalsIgnoreCase("side_menu_calendar")) {
