...
import com.procialize.vivo_app.Adapter.EventAdapter;
...
public class CalendeAdapter extends RecyclerView.Adapter<CalendeAdapter.MyViewHolder> implements Filterable {
    ...
    public CalendeAdapter(Context context, List<UserEventList> eventList,EventAdapterListner listener) {
