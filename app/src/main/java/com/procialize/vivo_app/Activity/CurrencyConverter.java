...
import com.procialize.vivo_app.GetterSetter.DropDownList;
import com.procialize.vivo_app.R;
import com.procialize.vivo_app.Session.SessionManager;
import com.procialize.vivo_app.Utility.ServiceHandler;
        ...
        btnConverter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else
                {
                    final AlertDialog.Builder builder = new AlertDialog.Builder(CurrencyConverter.this);
                    builder.setTitle("");
                    builder.setMessage("Please Select currency dropdown value");
