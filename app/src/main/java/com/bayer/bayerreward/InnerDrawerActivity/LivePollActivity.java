...
import com.bayer.bayerreward.Activity.PollDetailActivity;
import com.bayer.bayerreward.Adapter.PollNewAdapter;
...
import com.bayer.bayerreward.GetterSetter.LivePollList;
import com.bayer.bayerreward.GetterSetter.LivePollOptionList;
...
//        pollRv.setLayoutManager(mLayoutManager);
        ...
        CommonFunction.crashlytics("Livepoll","");
        firbaseAnalytics(this,"Livepoll","");
    }
    ...
    public void onContactSelected(LivePollList pollList) {
        ...
        if (pollList.getReplied().equalsIgnoreCase("1")) {
            if (pollList.getShow_result().equalsIgnoreCase("1")) {
                Toast.makeText(LivePollActivity.this, "You are already submit Live Poll.", Toast.LENGTH_SHORT).show();
            } else {
