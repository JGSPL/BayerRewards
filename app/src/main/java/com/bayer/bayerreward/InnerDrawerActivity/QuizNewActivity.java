...
import com.bayer.bayerreward.Adapter.QuizAdapter;
...
//		quizNameList.setItemViewCacheSize(0);
        ...
        quizNameList.setNestedScrollingEnabled(true);
...
//		});
        ...
        CommonFunction.crashlytics("QuizNewActivity", "");
        firbaseAnalytics(this, "QuizNewActivity", "");
    }
