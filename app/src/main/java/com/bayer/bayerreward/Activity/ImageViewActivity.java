...
//            bmpUri = Uri.fromFile(file);
            bmpUri = FileProvider.getUriForFile(context, "com.bayer.bayerreward.android.fileprovider", file);
                                    ...
                                    .into(new com.squareup.picasso.Target() {
                                              ...
                                              public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                                                  try {
                                                      ...
                                                      File myDir = new File(root + "/BayerReward");

                                                      if (!myDir.exists()) {
                                                          myDir.mkdirs();
                                                      }
                                                      Toast.makeText(ImageViewActivity.this,
                                                              "Download completed- check folder BayerReward/Image",
...
*/
        ...
        CommonFunction.crashlytics("ImageView","");
        firbaseAnalytics(this,"ImageView","");
    }
    ...
    private class ImageDownloadAndSave extends AsyncTask<String, Void, Bitmap> {
        ...
        private void downloadImagesToSdCard(String downloadUrl, String imageName) {
            try {
                ...
                File myDir = new File(sdCard, "BayerReward");
