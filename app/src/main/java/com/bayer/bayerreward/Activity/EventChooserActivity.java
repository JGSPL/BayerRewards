...
import com.bayer.bayerreward.Adapter.EventAdapter;
...
import com.bayer.bayerreward.GetterSetter.UserEventList;
...
//                progressBar.setVisibility(View.GONE);
        ...
        if (cd.isConnectingToInternet()) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                if (EventChooserActivity.this.checkSelfPermission(
                    ...
                    ActivityCompat.requestPermissions(EventChooserActivity.this, permissions, 0);
                } else if (EventChooserActivity.this.checkSelfPermission(
...
//                                                Toast.LENGTH_SHORT).show();
    ...
    public void sendLogin(String email, String password, final String eventid, String registration_id, String platform, String device, String os_version, String app_version) {
        mAPIService.LoginPost( password, eventid, registration_id, platform, device, os_version, app_version).enqueue(new Callback<Login>() {
            @Override
