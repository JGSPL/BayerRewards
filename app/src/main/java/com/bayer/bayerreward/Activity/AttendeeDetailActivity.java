...
//            linear.setBackgroundDrawable(ContextCompat.getDrawable(AttendeeDetailActivity.this, R.drawable.backdrop));
        }
...
//                    addToContactList(AttendeeDetailActivity.this, name, mobile);
        ...
        CommonFunction.crashlytics("AttendeeDetail","");
        firbaseAnalytics(this,"AttendeeDetail","");
    }
