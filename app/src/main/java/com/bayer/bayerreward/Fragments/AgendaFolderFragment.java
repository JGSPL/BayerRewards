...
import com.bayer.bayerreward.Adapter.SwipeAgendaImageAdapter;
import com.bayer.bayerreward.Adapter.SwipepagerAgendaImage;
...
import com.bayer.bayerreward.CustomTools.AutoScrollViewPager;
...
import com.bayer.bayerreward.GetterSetter.AgendaFolder;
...
//            linear.setBackgroundDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.backdrop));
        }
...
//		agendaTabHost.getTabWidget().setDividerDrawable(R.drawable.vertical_divider);
        CommonFunction.crashlytics("AgendaFolderFragment","");
        firbaseAnalytics(getActivity(),"AgendaFolderFragment","");
        return rootView;
