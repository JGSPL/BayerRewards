...
import com.bayer.bayerreward.Adapter.AgendaFolderListAdapter;
...
public class AgendaFolderListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.agenda_list_fragment,
                container, false);
        CommonFunction.crashlytics("AgendaFolderListFrag","");
        firbaseAnalytics(getActivity(),"AgendaFolderListFrag","");
        return rootView;
    }
