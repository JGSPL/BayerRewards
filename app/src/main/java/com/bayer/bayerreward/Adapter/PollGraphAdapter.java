...
public class PollGraphAdapter extends RecyclerView.Adapter<PollGraphAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        String[] color = {"#0091DF", "#Ff6600", "#5A9D30", "#FEA201", "#2B6636", "#0091DF", "#Ff6600", "#5A9D30", "#FEA201", "#2B6636", "#0091DF", "#Ff6600"};
        ...
        GradientDrawable shape = setgradientDrawable(30, color[position]);
        ll2.setBackground(shape);
