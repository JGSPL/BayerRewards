...
public class BuisnessUnitAdapter extends RecyclerView.Adapter<BuisnessUnitAdapter.MyViewHolder> {

    String MY_PREFS_NAME = "ProcializeInfo";
    String MY_PREFS_LOGIN = "ProcializeLogin";
    String colorActive;
    private List<business_unit_data> business_unit_datas;
    private Context context;


    public BuisnessUnitAdapter(Context context, List<business_unit_data> business_unit_data) {
        this.business_unit_datas = business_unit_data;
    ...
    @Override
    public BuisnessUnitAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.territory_items, parent, false);

        return new BuisnessUnitAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final BuisnessUnitAdapter.MyViewHolder holder, int position) {
        final business_unit_data travel = business_unit_datas.get(position);
    ...
    public int getItemCount() {
        return business_unit_datas.size();
    }
