package com.bayer.bayerreward.Session;
...
//    public static final String KEY_EMAILID = "emailid";
    ...
    public static final String KEY_URIID = "uri_id";
...
//    public static final String KEY_city= "profile_pic";
    ...
    public void createLoginSession(String fstname, String lstname, String email, String mobile, String company,
                                   ...
                                   String password, String skip_flag, String attendee_status,String uriid, String addr1, String addr2) {
        ...
        editor.putString(KEY_URIID, pref.getString(KEY_URIID, null));
        editor.putString(ADDRESS1, pref.getString(ADDRESS1, null));
        editor.putString(ADDRESS2, pref.getString(ADDRESS2, null));
        // commit changes
        editor.commit();
    }
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        user.put(KEY_URIID, pref.getString(KEY_URIID, null));
        user.put(ADDRESS1, pref.getString(ADDRESS1, null));
        user.put(ADDRESS2, pref.getString(ADDRESS2, null));
...
//        _context.startActivity(i);
    ...
    public void createProfileSession(String name, String company, String designation, String pic, String lastname, String city, String description, String country, String email, String mobno, String attendee_type, String uriid, String addr1, String addr2) {
        ...
        editor.putString(KEY_URIID, uriid);
        editor.putString(ADDRESS1, addr1);
        editor.putString(ADDRESS2, addr2);
